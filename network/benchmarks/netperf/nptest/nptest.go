...
func init() {
        ...
        testcases = []*testcase{
                {SourceNode: "netperf-w1", DestinationNode: "netperf-w2", Label: "1 iperf TCP. Same VM using Pod IP", Type: iperfTcpTest, IP: "PodIP", MSS: mssMin},
                {SourceNode: "netperf-w1", DestinationNode: "netperf-w2", Label: "2 iperf TCP. Same VM using Virtual IP", Type: iperfTcpTest, IP: "ClusterIP", MSS: mssMin},
                {SourceNode: "netperf-w1", DestinationNode: "netperf-w3", Label: "3 iperf TCP. Remote VM using Pod IP", Type: iperfTcpTest, IP: "PodIP", MSS: mssMin},
                {SourceNode: "netperf-w3", DestinationNode: "netperf-w2", Label: "4 iperf TCP. Remote VM using Virtual IP", Type: iperfTcpTest, IP: "ClusterIP", MSS: mssMin},
                {SourceNode: "netperf-w2", DestinationNode: "netperf-w2", Label: "5 iperf TCP. Hairpin Pod to own Virtual IP", Type: iperfTcpTest, IP: "ClusterIP", MSS: mssMin},
                {SourceNode: "netperf-w4", DestinationNode: "netperf-w2", Label: "6 iperf TCP. External to service using externalIP", Type: iperfTcpTest, IP: "NodeIP", MSS: mssMin},
                {SourceNode: "netperf-w1", DestinationNode: "netperf-w2", Label: "7 iperf UDP. Same VM using Pod IP", Type: iperfUdpTest, IP: "PodIP", MSS: mssMax},
                {SourceNode: "netperf-w1", DestinationNode: "netperf-w2", Label: "8 iperf UDP. Same VM using Virtual IP", Type: iperfUdpTest, IP: "ClusterIP", MSS: mssMax},
                {SourceNode: "netperf-w1", DestinationNode: "netperf-w3", Label: "9 iperf UDP. Remote VM using Pod IP", Type: iperfUdpTest, IP: "PodIP", MSS: mssMax},
                {SourceNode: "netperf-w3", DestinationNode: "netperf-w2", Label: "10 iperf UDP. Remote VM using Virtual IP", Type: iperfUdpTest, IP: "ClusterIP", MSS: mssMax},
                {SourceNode: "netperf-w4", DestinationNode: "netperf-w2", Label: "11 iperf UDP. External to service using externalIP", Type: iperfUdpTest, IP: "NodeIP", MSS: mssMax},
                {SourceNode: "netperf-w1", DestinationNode: "netperf-w2", Label: "12 netperf. Same VM using Pod IP", Type: netperfTest, IP: "PodIP"},
                {SourceNode: "netperf-w1", DestinationNode: "netperf-w2", Label: "13 netperf. Same VM using Virtual IP", Type: netperfTest, IP: "ClusterIP"},
                {SourceNode: "netperf-w1", DestinationNode: "netperf-w3", Label: "14 netperf. Remote VM using Pod IP", Type: netperfTest, IP: "PodIP"},
                {SourceNode: "netperf-w3", DestinationNode: "netperf-w2", Label: "15 netperf. Remote VM using Virtual IP", Type: netperfHTTPTest, IP: "ClusterIP"},
                {SourceNode: "netperf-w1", DestinationNode: "netperf-w2", Label: "16 netperf HTTP. Same VM using Pod IP", Type: netperfHTTPTest, IP: "PodIP"},
                {SourceNode: "netperf-w1", DestinationNode: "netperf-w2", Label: "17 netperf HTTP. Same VM using Virtual IP", Type: netperfHTTPTest, IP: "ClusterIP"},
                {SourceNode: "netperf-w1", DestinationNode: "netperf-w3", Label: "18 netperf HTTP. Remote VM using Pod IP", Type: netperfHTTPTest, IP: "PodIP", MSS: mssMin},
                {SourceNode: "netperf-w3", DestinationNode: "netperf-w2", Label: "19 netperf HTTP. Remote VM using Virtual IP", Type: netperfHTTPTest, IP: "ClusterIP"},
                {SourceNode: "netperf-w2", DestinationNode: "netperf-w2", Label: "20 netperf HTTP. Hairpin Pod to own Virtual IP", Type: netperfHTTPTest, IP: "ClusterIP"},
        }
...
func allocateWorkToClient(workerS *workerState, reply *WorkItem) {
        ...
        for n, v := range testcases {
                ...
                case "NodeIP":
                        reply.ClientItem.Host = os.Getenv("primaryNodeIP")
                }
